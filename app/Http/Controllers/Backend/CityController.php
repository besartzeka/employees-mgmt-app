...
class CityController extends Controller
{
    ...
    public function update(CityStoreRequest $request, City $city)
    {
        ...
        return redirect()->route('cities.index')->with('message', 'The city is successfully updated!');
    }
    ...
    {
        $city->delete();
        return redirect()->route('cities.index')->with('message', "City with ID:$city->id deleted successfully!");
    }
}
