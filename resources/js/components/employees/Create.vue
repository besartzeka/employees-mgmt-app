                  ...
                  <form @submit.prevent="storeEmployee">
                     <div class="form-row">
                        <div class="col-md-6">
                           ...
                           <div class="form-group row">
                                <label for="country" class="col-md-4 col-form-label text-md-right">County</label>
                                <div class="col-md-6">
                                    <select 
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="form-group row">
                              <label for="dob" class="col-md-4 col-form-label text-md-right">Date Hired</label>
                              <div class="col-md-6">
                                 <input id="date_hired" type="date" class="form-control" required>
                              </div>
                           </div>
                           -->
                        </div>
